...
public class NavegacionUsuarioTemplate extends JPanel {
  ...
  public void crearObjetosDecoradores() {
    this.iIconoUsuario = new ImageIcon("Clase7/resources/images/usuario_navegacion.png");
    this.iInicio = new ImageIcon("Clase7/resources/images/inicio.png");
    this.iPerfil = new ImageIcon("Clase7/resources/images/perfil.png");
    this.iAmigos = new ImageIcon("Clase7/resources/images/amigos.png");
    this.iProductos = new ImageIcon("Clase7/resources/images/productos.png");
    this.iConfiguracion = new ImageIcon("Clase7/resources/images/configuracion.png");
    this.iCerrarSesion = new ImageIcon("Clase7/resources/images/salir.png");
    this.iImagenUsuario = new ImageIcon("Clase7/resources/images/perfiles/perfil1.png");
