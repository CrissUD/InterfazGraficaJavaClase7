...
public class NavegacionUsuarioTemplate extends JPanel{
    ...
    public void crearObjetosDecoradores(){
        ...
        this.iIconoUsuario = new ImageIcon("clase7/resources/img/usuario_navegacion.png");
        this.iInicio = new ImageIcon("clase7/resources/img/inicio.png");
        this.iPerfil = new ImageIcon("clase7/resources/img/perfil.png");
        this.iAmigos = new ImageIcon("clase7/resources/img/amigos.png");
        this.iProductos = new ImageIcon("clase7/resources/img/productos.png");
        this.iConfiguracion = new ImageIcon("clase7/resources/img/configuracion.png");
        this.iCerrarSesion = new ImageIcon("clase7/resources/img/salir.png");
        this.iImagenUsuario = new ImageIcon("clase7/resources/img/perfiles/perfil1.png");
    }
