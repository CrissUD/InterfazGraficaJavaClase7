...
public class LoginTemplate extends JFrame {
    ...
    public void crearObjetosDecoradores(){
        ...
        iFondo = new ImageIcon("clase7/resources/img/fondo.png");
        iLogo = new ImageIcon("clase7/resources/img/logo.png");
        iUsuario = new ImageIcon("clase7/resources/img/usuario.png");
        iClave = new ImageIcon("clase7/resources/img/clave.png");
        iPunto = new ImageIcon("clase7/resources/img/punto.png");
        iFacebook = new ImageIcon("clase7/resources/img/facebook.png");
        iTwitter = new ImageIcon("clase7/resources/img/twitter.png");
        iYoutube = new ImageIcon("clase7/resources/img/youtube.png");
        iSvg = new ImageIcon("clase7/resources/img/imagen.png");
    }
